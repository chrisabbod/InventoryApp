...
public class DetailActivity extends AppCompatActivity {
    ...
    private void insertInventory(){
        ...
        values.put(InventoryContract.InventoryEntry.COLUMN_PRODUCT_SUPPLIER_NUMBER, supplierNumberString);
    ...
    private void displayDatabaseInfo(){
        ...
        try{
            ...
            int supplierNumberColumnIndex = cursor.getColumnIndex(InventoryContract.InventoryEntry.COLUMN_PRODUCT_SUPPLIER_NUMBER);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save_data:
                insertInventory();
                Toast.makeText(DetailActivity.this, "Inventory Saved", Toast.LENGTH_SHORT).show();
                displayDatabaseInfo();
